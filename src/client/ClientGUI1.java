...
public class ClientGUI1 {
     ...
     */
    public ClientGUI1(String client_keystore_location, String client_keystore_password, String hostname, int hostport) {
        ...
        if (this.sslContext == null) {
            ...
            if (this.socketFactory == null) {
                ...
                this.mainFrame = new JFrame(ClientGUI1.MAINFRAMETITLE);
                ...
                this.controls = new JPanel(new GridLayout(0, 2));
                {
                    ...
                    this.registerUsername_label = new JLabel(ClientGUI1.REGISTERUSERNAME_LABEL_TEXT);
                    this.registerPassword_label = new JLabel(ClientGUI1.REGISTERPASSWORD_LABEL_TEXT);
                    this.firstName_label = new JLabel(ClientGUI1.FIRSTNAME_LABEL_TEXT);
                    this.lastName_label = new JLabel(ClientGUI1.LASTNAME_LABEL_TEXT);
                    // LoginRequest:
                    this.loginUsername = new JTextField();
                    this.loginPassword = new JTextField();
                    this.loginUsername_label = new JLabel(ClientGUI1.LOGINUSERNAME_LABEL_TEXT);
                    this.loginPassword_label = new JLabel(ClientGUI1.LOGINPASSWORD_LABEL_TEXT);
                    // ChangePasswordRequest:
                    this.oldPassword = new JTextField();
                    this.newPassword = new JTextField();
                    this.oldPassword_label = new JLabel(ClientGUI1.OLDPASSWORD_LABEL_TEXT);
                    this.newPassword_label = new JLabel(ClientGUI1.NEWPASSWORD_LABEL_TEXT);
                    // Money operations:
                    this.moneyCurrency = new JTextField();
                    this.moneyAmount = new JTextField();
                    this.moneyCurrency_label = new JLabel(ClientGUI1.MONEYCURRENCY_LABEL_TEXT);
                    this.moneyAmount_label = new JLabel(ClientGUI1.MONEYAMOUNT_LABEL_TEXT);
                    // CreateBankAccountRequest:
                    this.bankAccountType = new JTextField();
                    this.bankAccountType_label = new JLabel(ClientGUI1.BANKACCOUNTTYPE_LABEL_TEXT);
                    // DepositRequest, TransferRequest:
                    this.toBankAccount = new JTextField();
                    this.toBankAccount_label = new JLabel(ClientGUI1.TOBANKACCOUNT_LABEL_TEXT);
                    // WithdrawRequest, TransferRequest:
                    this.fromBankAccount = new JTextField();
                    this.fromBankAccount_label = new JLabel(ClientGUI1.FROMBANKACCOUNT_LABEL_TEXT);
                }
                {
                    // RegisterRequest:
                ...
                this.buttons = new JPanel(new GridLayout(0, 2));
                {
                    // Send buttons:
                    // RegisterRequest
                    this.sendButton_RegisterRequest = new JButton(ClientGUI1.SENDBUTTON_REGISTERREQUEST_TEXT);
                    ...
                    // LoginRequest
                    this.sendButton_LoginRequest = new JButton(ClientGUI1.SENDBUTTON_LOGINREQUEST_TEXT);
                    ...
                    // LogoutRequest
                    this.sendButton_LogoutRequest = new JButton(ClientGUI1.SENDBUTTON_LOGOUTREQUEST_TEXT);
                    ...
                    // ChangePasswordRequest
                    this.sendButton_ChangePasswordRequest = new JButton(ClientGUI1.SENDBUTTON_CHANGEPASSWORDREQUEST_TEXT);
                    ...
                    // BalanceRequest
                    this.sendButton_BalanceRequest = new JButton(ClientGUI1.SENDBUTTON_BALANCEREQUEST_TEXT);
                    ...
                    // TransactionHistoryRequest
                    this.sendButton_TransactionHistoryRequest = new JButton(ClientGUI1.SENDBUTTON_TRANSACTIONHISTORYREQUEST_TEXT);
                    ...
                    // CurrencyRatesRequest
                    this.sendButton_CurrencyRatesRequest = new JButton(ClientGUI1.SENDBUTTON_CURRENCYRATESREQUEST_TEXT);
                    ...
                    // CreateBankAccountRequest
                    this.sendButton_CreateBankAccountRequest = new JButton(ClientGUI1.SENDBUTTON_CREATEBANKACCOUNTREQUEST_TEXT);
                    ...
                    // DepositRequest
                    this.sendButton_DepositRequest = new JButton(ClientGUI1.SENDBUTTON_DEPOSITREQUEST_TEXT);
                    ...
                    // WithdrawRequest
                    this.sendButton_WithdrawRequest = new JButton(ClientGUI1.SENDBUTTON_WITHDRAWREQUEST_TEXT);
                    ...
                    // TransferRequest
                    this.sendButton_TransferRequest = new JButton(ClientGUI1.SENDBUTTON_TRANSFERREQUEST_TEXT);
                    ...
                    // EXIT button:
                    this.exitButton = new JButton(ClientGUI1.EXITBUTTON_TEXT);
                ...
                // добавяне на лентата с главното меню:
                {
                    ...
                    this.menu_Account = new JMenu(ClientGUI1.MENU_ACCOUNT_TEXT);
                    {
                        this.menu_Account_LoginRequest = new JMenuItem(ClientGUI1.MENU_ACCOUNT_LOGINREQUEST_TEXT);
                        this.menu_Account_RegisterRequest = new JMenuItem(ClientGUI1.MENU_ACCOUNT_REGISTERREQUEST_TEXT);
                        this.menu_Account_ChangePasswordRequest = new JMenuItem(ClientGUI1.MENU_ACCOUNT_CHANGEPASSWORDREQUEST_TEXT);
                        this.menu_Account_LogoutRequest = new JMenuItem(ClientGUI1.MENU_ACCOUNT_LOGOUTREQUEST_TEXT);
                    ...
                    this.menu_Update = new JMenu(ClientGUI1.MENU_UPDATE_TEXT);
                    {
                        this.menu_Update_BalanceRequest = new JMenuItem(ClientGUI1.MENU_UPDATE_BALANCEREQUEST_TEXT);
                        this.menu_Update_TransactionHistoryRequest = new JMenuItem(ClientGUI1.MENU_UPDATE_TRANSACTIONHISTORYREQUEST_TEXT);
                        this.menu_Update_CurrencyRatesRequest = new JMenuItem(ClientGUI1.MENU_UPDATE_CURRENCYRATESREQUEST_TEXT);
                        // добавяне на action listener-и:
                    ...
                    this.menu_Order = new JMenu(ClientGUI1.MENU_ORDER_TEXT);
                    {
                        this.menu_Order_CreateBankAccountRequest = new JMenuItem(ClientGUI1.MENU_ORDER_CREATEBANKACCOUNTREQUEST_TEXT);
                        this.menu_Order_DepositRequest = new JMenuItem(ClientGUI1.MENU_ORDER_DEPOSITREQUEST_TEXT);
                        this.menu_Order_WithdrawRequest = new JMenuItem(ClientGUI1.MENU_ORDER_WITHDRAWREQUEST_TEXT);
                        this.menu_Order_TransferRequest = new JMenuItem(ClientGUI1.MENU_ORDER_TRANSFERREQUEST_TEXT);
                        // добавяне на action listener-и:
    ...
    public static void main(String[] args) {
        ...
        ClientGUI1 clientGUI = new ClientGUI1(CLIENT_KEYSTORE_LOCATION, CLIENT_KEYSTORE_PASSWORD, HOSTNAME, HOSTPORT);
    }
}
